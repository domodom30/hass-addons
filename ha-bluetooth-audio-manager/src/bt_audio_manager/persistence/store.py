...
DEFAULT_DEVICE_SETTINGS = {
    ...
    "mpd_volume_hardware": False,  # True = volume_set drives the speaker's hardware/AVRCP volume (MPD hardware mixer + always_on, power-save disabled); False = software mixer (idle-safe, MPD attenuates its own stream)
