...
| [**Bluetooth Audio Manager**](./ha-bluetooth-audio-manager) | `2.9.0` | Gestion des périphériques audio Bluetooth (A2DP) avec appairage persistant et reconnexion automatique. | aarch64, amd64, armv7, armhf |
